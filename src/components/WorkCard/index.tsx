...
const WorkCard = ({ company, designation, timeline, image: Img, latest }: WorkCardProps) => {
    return (
        <div className="rounded-[18px] shadow-[2px_4px_12px_#0071e314] relative mr-8 my-8 hover:shadow-[2px_4px_16px_#0071e324] cursor-pointer custom-transform min-w-[40rem] h-[50rem]">
            {latest ? (
                <div className="flex flex-col h-full justify-between rounded-[18px] bg-white overflow-hidden">
                    <div className="flex flex-col p-12">
                        ...
                        <span className="text-[2.5rem] text-[#1d1d1f] font-semibold">
                            {company}
                        </span>

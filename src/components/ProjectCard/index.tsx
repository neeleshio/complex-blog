...
const ProjectCard = ({ name, image: Image, description, stack, latest }: ProjectCardProps) => {
    return (
        <div className="flex flex-col justify-center rounded-[18px] min-w-[31rem] h-[40rem] bg-invert-primary shadow-[2px_4px_12px_#00000014] mr-8 p-12 pt-20 my-8 hover:shadow-[2px_4px_16px_#00000029] cursor-pointer custom-transform border-[#f5f5f72e] border border-solid">

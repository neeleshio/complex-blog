...
const BlogCard = ({ title, image: Image, link }: BlogCardProps) => {
    return (
        <>
            <div className="flex flex-col justify-start rounded-[18px] min-w-[31rem] h-[24rem] bg-white shadow-[2px_4px_12px_#00000014] mr-8 px-12 pt-16 hover:shadow-[2px_4px_16px_#00000029] cursor-pointer custom-transform">
